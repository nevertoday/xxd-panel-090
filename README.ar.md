<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 090" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 090｜خريطة التفكير البصري

### يرسم العلاقات والمعاني خلف الصورة كخريطة تفكير بصري
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 090 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

لا يشرح رسم الشيء إلا «ما هو»، بينما تختزل مخططات التدفق وواجهات التقنية المعنى في قالب ثابت. يرسم 090 العلاقة والعملية والحالة والدلالة.

يتعامل **Panel 090** مع الصورة كمركز مفاهيمي، ويفكك الحركة والاتجاه والفضاء والعاطفة والعلاقة والاستعارة إلى كلمات وعقد ومسارات ومناطق وأسهم وروابط. تبني الدلالة النصية والعلاقات الهندسية وآثار اليد خريطة فنية بين الرسم والمخطط وملاحظة التفكير.

### مناسب لـ

- **التعبير عن عملية التفكير خلف الصورة:** ينظّم الحركة والاتجاه والعلاقات والعاطفة في مركز مفاهيمي ومسارات بصرية؛
- **الحاجة إلى رسم تخطيطي فني لا مخطط علمي:** يستخدم تراكيب مثلثة وخطوطًا منكسرة ومحاور متقاطعة وخطوطًا شعاعية وكنتورات ومسارات حقول؛
- **البحث عن توتر بين العقلانية والجسدية:** يراكب هيكلًا هندسيًا واضحًا مع خطوط قصيرة متكررة وتدريجات ورموز ونقاط وانزياحات يدوية طفيفة؛
- **الحاجة إلى تسليم مرن:** يدعم الأعلى–الأسفل واليسار–اليمين والتصميم فقط ونسبًا متعددة وخلفيات لأربعة أجهزة ومعالجة مجلدات الصور دفعة واحدة.

### بداية سريعة

> استخدم XXD Panel 090 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** تفكير بصري · خرائط مفاهيمية · رسم تخطيطي · طباعة تجريبية · تدوين بصري · آثار يدوية
...
|---|---|
| **الناتج** | خريطة تفكير بصري تنظم علاقات الصورة وعملياتها وحالاتها واستعاراتها |
| **البصمة الواضحة** | عقد نصية، هيكل هندسي، مسارات وأسهم، علامات اتجاهية، انزياحات يدوية وفراغ واسع |
| **احترام المصدر** | يجعل الموضوع والحركة والفضاء والعاطفة والسرد مركزًا مفاهيميًا بدل شرح الشيء |
...
```text
تحليل الموضوع والمحيط والوضعية والعلاقات السردية → جعل الصورة مركزًا مفاهيميًا → تفكيك الحركة والاتجاه والفضاء والعاطفة والعلاقات والاستعارات → بناء نظام دلالي من الكلمات والعُقد والمسارات والمناطق والأسهم والروابط → تنظيم الهيكل الهندسي بالمثلثات والخطوط المنكسرة والمحاور المتقاطعة والخطوط الشعاعية → إضافة خطوط الكنتور والحقول والمسارات الموجية وmark-making اتجاهي → إتمام التدوين البصري بنص محدود وفراغ واسع
```

## سمات النتيجة النهائية

- تبقى الخطوط الهندسية واضحة وحادة ومنضبطة؛ ويُسمح للآثار اليدوية بانزياح وانقطاع وعدم انتظام طفيف، لينشأ توتر بين البنية العقلانية والضربات الجسدية.
- يحمل الأسود أو الرمادي الفحمي أو لون مركب داكن النص والهيكل، بينما تحمل 1–3 ألوان حية مشتقة من الأصل العُقد والمسارات وحقول الكثافة.
- يظل النص مقروءًا ويعمل في الوقت نفسه كعُقد وإحداثيات وتدوين بصري عبر تباين الحجم والتدوير والتكرار والتراكب والترتيب على المسارات والتفكيك الموضعي.
- يُحفظ فراغ فاتح واسع لتتنفس العلاقات والاتجاهات والمعلومات؛ ولا تُملأ اللوحة بشبكة منتظمة.
- تجنّب خرائط العقل التقليدية ومخططات التدفق القياسية ولوحات بيانات القياس وواجهات التقنية والواجهات السيبرانية والخطوط الزخرفية العشوائية وتكديس المعلومات المعقدة والرسم الواقعي والإنفوغرافيك القالبي.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-090-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 090. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-090 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-090 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-090 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-090 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-090 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 090 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-090 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-090`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-090-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-090-prompt.zh-CN.md)
...
| **[xxd-panel-090](https://github.com/nevertoday/xxd-panel-090)** | تفكير بصري · رسم مفاهيمي · رسم تخطيطي · طباعة تجريبية · تدوين بصري · آثار يدوية |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–090) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
