...
```text
/xxd-panel-090 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，090 设计在下）
2. 左右对照（原图在左，090 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-090/<fresh-task>/
...
- `references/xxd-panel-090-prompt.zh-CN.md`
- `references/xxd-panel-090-prompt.en.md`
