...
Each of the 90 Panels preserves its own original brief and aesthetic logic. The table continuously lists every project from 001 through 090 with its defining style characteristics; the current project is bold.
