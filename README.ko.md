...
예시 영역은 예약되어 있습니다. 검증 가능한 원작 링크나 090 원본 프롬프트와 직접 대조한 확장 예시가 준비되면 이곳에 먼저 표시하며, 다른 번호의 이미지나 깨진 자리표시자로 대신하지 않습니다.

<!-- xxd-human-intro:start -->
## 이 스타일이 해결하는 문제

사물 설명도는 “무엇인가”만 말하고, 흐름도와 테크 UI는 의미를 고정된 틀로 평평하게 만듭니다. 090은 관계·과정·상태·암시를 그립니다.
...
| 확인할 점 | 이 스타일의 답 |
|---|---|
| **결과물** | 사진의 관계·과정·상태·암시를 조직한 시각적 사고 지도 |
