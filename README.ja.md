...
作例枠は確保済みです。検証可能な原作リンク、または 090 原文プロンプトに直接照合した追加作例が揃い次第ここで優先表示し、別番号の画像や壊れたプレースホルダーで代用しません。

<!-- xxd-human-intro:start -->
## このスタイルが解決すること

物体説明図は「何か」しか示せず、フローチャートやテック UI は意味を定型化します。090 は関係・過程・状態・暗示を描きます。

**Panel 090** は写真を概念中心として、動作、方向、空間、感情、関係、比喩を文字、ノード、軌跡、領域、矢印、接続へ分解します。文字意味、幾何関係、手仕事の痕跡が、絵画・図表・思考ノートの間にある地図を作ります。
